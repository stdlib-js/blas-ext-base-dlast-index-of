...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-dlast-index-of/tags). For example,

```javascript
dlastIndexOf = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dlast-index-of@v0.1.0-umd/browser.js' )
```
